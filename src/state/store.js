...
export const state = {
  ...
  gastosRecurrentes: [
    ...
    { id: 'gr7', nombre: 'Apple.com', emoji: '🍎', monto: 9022, dia_vencimiento: 15 },
    { id: 'gr8', nombre: 'Gmail', emoji: '📧', monto: 2015, dia_vencimiento: 16 },
    { id: 'gr9', nombre: 'Lightroom', emoji: '🖼️', monto: 8515, dia_vencimiento: 16 },
    { id: 'gr10', nombre: 'Aseo personal (shampú, jabón, cuchillas, desodorante, contorno, etc)', emoji: '🧴', monto: 120000, dia_vencimiento: 20 },
